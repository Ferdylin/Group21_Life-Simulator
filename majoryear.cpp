...
void Events19(Show &s, string name, ofstream &fout) {
    ...
    if (choice == 1) {
        ...
        //save game
        fout << endl
             << "Choice: Dealing with my study as usual, meanwhile looking for remote internships and winter / summer internships."
             << endl;
        ...
        //save game
        fout << endl << "Choice:  What? Shouldn’t college students be in lecture halls? Nah, I don’t need internships."
             << endl;
        fout
                << "You at job interviews after graduation: what do you mean “you won’t consider college graduates with no internship experiences”?!"
                << endl;
...
void Events24(Show &s, string name, ofstream &fout) {
    ...
    if (choice == 1) {
        ...
        cout
                << "Miserable life ahead. Your job at the company is boring, repetitive, low-pay and there’s hardly any chances of promotion. Soon before you decide to quit and find a job again."
                << endl;
        cout << "<satisfaction-1>" << endl;
        ChangeStats(s, 0, 0, -1);
        ...
        cout << "The job is very demanding and tiring. But there is always a chance that you make the right bet."
             << endl;
        ...
        fout << "The job is very demanding and tiring. But there is always a chance that you make the right bet."
             << endl;
    }
}
...
void Events25(Show &s, string name, ofstream &fout) {
    ...
    if (choice == 1) {
        cout
                << "You got unemployed for over a month since you do not have enough work experiences, but eventually landed with a normal job in Hong Kong"
                << endl;
        cout << "<Wealth -1>" << endl;
        ChangeStats(s, -1, 0, 0);
        ...
        cout
                << "Your work still was not recognized by any colleagues, and they just kept gossiping about you because they know that you’re not liked by the boss"
                << endl;
        cout << "<Satisfaction -2>" << endl;
        ChangeStats(s, 0, 0, -2);
        ...
        //save game
        fout << endl
             << "Choice: Keep up with the hard work because you believe that your work would be recognized one day"
             << endl;
        fout
                << "Your work still was not recognized by any colleagues, and they just kept gossiping about you because they know that you’re not liked by the boss"
                << endl;
...
void Events30(Show &s, string name, ofstream &fout) {
    ...
    if (choice == 1) {
        cout
                << "You used up a lot of your money, but your partner was very grateful for your effort. They have decided to cook healthy food for you to take to your workplace every day, you felt that your health is improving as you eat healthy."
                << endl;
        ...
        // save game
        fout << endl
             << "Choice: Agree with them completely, you sold one of your apartments in Hong Kong, and decided to do everything you can to help your mother-in-law out."
             << endl;
        fout
                << "You used up a lot of your money, but your partner was very grateful for your effort. They have decided to cook healthy food for you to take to your workplace every day, you felt that your health is improving as you eat healthy. "
                << endl;
        ...
        cout
                << "You and your partner fought, they wanted to break up and thought that you’re a cold-blooded monster. You felt very helpless and didn't know what to do. "
                << endl;
        cout << "<Health -1, Satisfaction -2>" << endl;
        ChangeStats(s, 0, -1, -2);
        ...
        //save game
        fout << endl
             << "Choice: You told your partner that you cannot afford to send your mother-in-law to Australia but still wanted to find them a solution"
             << endl;
        fout
                << "You and your partner fought, they wanted to break up and thought that you’re a cold-blooded monster. You felt very helpless and didn't know what to do. "
                << endl;
...
void Events31(Show &s, string name, ofstream &fout) {
    ...
    if (choice == 1) {
        ...
        cout
                << "You think about it and decide not to have children, to give yourself more personal time and the energy to do your own thing."
                << endl;
...
void Events36(Show &s, string name, ofstream &fout) {
    ...
    cout << "--------------------------------------------------" << endl;
    cout
            << "You have reached a bottleneck in your career, and you want to move up further and improve the quality of life for your family, you decide to"
            << endl;
    ...
    if (choice == 1) {
        ...
        cout
                << "You often ask your boss to go out for dinner after work, and you are socializing more, trying to get on good terms with your clients' bosses. "
                << endl;
